import{j as n}from"./framer-B3ouEdmE.js";import{r}from"./react-DnQQq7lD.js";import{B as x}from"./index-xHJnq0ry.js";import{W as j,F as P,G as L,I as H}from"./index-xHJnq0ry.js";const g=[{id:"getting-started",title:"Bắt Đầu Tu Tiên",icon:"◆",category:"basics",content:`Chào mừng tiểu hữu đến với thế giới tu tiên.
...
> Mẹo: Đem theo đan dược hồi máu + linh thú tank trước khi vào.`}],u=[{id:"basics",label:"Cơ Bản",icon:"◆"},{id:"cultivation",label:"Tu Luyện",icon:"✦"},{id:"combat",label:"Combat",icon:"⚔"},{id:"society",label:"Xã Hội",icon:"◈"},{id:"advanced",label:"Nâng Cao",icon:"☆"}],f=({open:o,onClose:l,initialEntryId:e})=>{const[i,h]=r.useState("basics"),[c,a]=r.useState(e??"getting-started"),d=r.useMemo(()=>g.filter(t=>t.category===i),[i]),s=r.useMemo(()=>g.find(t=>t.id===c)??g[0],[c]);return o?n.jsx("div",{className:"fixed inset-0 z-50 flex items-center justify-center p-4",style:{background:"rgba(8,11,15,.85)",backdropFilter:"blur(4px)"},onClick:l,children:n.jsx("div",{className:"relative w-full max-w-5xl",onClick:t=>t.stopPropagation(),style:{maxHeight:"90vh"},children:n.jsx(x,{className:"rounded-md border bg-ink-700",tone:"gold",children:n.jsxs("div",{className:"flex flex-col",style:{maxHeight:"85vh"},children:[n.jsxs("header",{className:"flex items-center justify-between border-b border-gold-700/15 px-6 py-4",children:[n.jsxs("div",{children:[n.jsx("div",{className:"label-section mb-1",children:"Wiki · Tu Tiên Toàn Thư"}),n.jsx("h2",{className:"font-serif text-2xl font-bold uppercase tracking-wider text-gold-200",children:"Cẩm Nang Tu Tiên"})]}),n.jsx("button",{onClick:l,className:"text-2xl text-gold-300 transition-colors hover:text-gold-100","aria-label":"Đóng cẩm nang",children:"⊗"})]}),n.jsx("nav",{className:"flex gap-1 overflow-x-auto border-b border-gold-700/10 px-4 py-2",children:u.map(t=>n.jsxs("button",{onClick:()=>{h(t.id);const p=g.find(b=>b.category===t.id);p&&a(p.id)},className:"flex-shrink-0 rounded-sm px-3 py-2 text-[12.5px] transition-colors whitespace-nowrap",style:{color:i===t.id?"var(--gold-100)":"var(--gold-300)",background:i===t.id?"rgba(205,164,94,.1)":"transparent",borderBottom:i===t.id?"2px solid var(--gold-500)":"2px solid transparent"},children:[n.jsx("span",{className:"mr-1.5 text-[11px]",style:{color:"var(--gold-500)"},children:t.icon}),t.label]},t.id))}),n.jsxs("div",{className:"grid flex-1 overflow-hidden md:grid-cols-[220px_1fr]",children:[n.jsx("aside",{className:"overflow-y-auto border-r border-gold-700/10 p-3",style:{maxHeight:"60vh"},children:n.jsx("div",{className:"space-y-1",children:d.map(t=>n.jsxs("button",{onClick:()=>a(t.id),className:"flex w-full items-start gap-2 rounded-sm px-3 py-2 text-left text-[12.5px] transition-colors",style:{background:c===t.id?"rgba(205,164,94,.08)":"transparent",color:c===t.id?"var(--gold-100)":"var(--gold-300)",borderLeft:c===t.id?"2px solid var(--gold-500)":"2px solid transparent"},children:[n.jsx("span",{style:{color:"var(--gold-500)",fontSize:13},children:t.icon}),n.jsx("span",{className:"leading-tight",children:t.title})]},t.id))})}),n.jsxs("article",{className:"overflow-y-auto p-6",style:{maxHeight:"60vh"},children:[n.jsxs("div",{className:"mb-4 flex items-center gap-3",children:[n.jsx("span",{className:"text-3xl",style:{color:"var(--gold-500)"},children:s.icon}),n.jsxs("div",{children:[n.jsx("div",{className:"label-section",children:u.find(t=>t.id===s.category)?.label}),n.jsx("h3",{className:"font-serif text-xl font-semibold text-gold-200",children:s.title})]})]}),n.jsx("div",{className:"prose-handbook text-[14px] leading-relaxed text-gold-300",children:y(s.content)})]})]}),n.jsxs("footer",{className:"border-t border-gold-700/15 px-6 py-3 text-center text-[11px] italic text-jade-500",children:["Mở Cẩm Nang bất cứ lúc nào bằng nút ",n.jsx("kbd",{className:"rounded border border-gold-700/30 bg-ink-800 px-1.5 py-0.5 text-gold-300",children:"?"})," trên thanh navigation"]})]})})})}):null};function y(o){return o.split(/\n\n+/).map((e,i)=>{const h=e.trim();if(h.startsWith(">"))return n.jsx("blockquote",{className:"my-3 rounded-r-sm border-l-2 border-gold-500/40 bg-gold-500/5 px-4 py-2 text-[13px] italic text-gold-200",children:m(h.replace(/^>\s*/,""))},i);if(h.startsWith("- ")){const c=h.split(`
`).map(a=>a.replace(/^-\s*/,""));return n.jsx("ul",{className:"my-3 space-y-1.5 pl-5",children:c.map((a,d)=>n.jsx("li",{className:"list-disc text-[13.5px] text-gold-300 marker:text-gold-500/60",children:m(a)},d))},i)}return n.jsx("p",{className:"mb-3 text-[14px] leading-relaxed text-gold-300/95",children:m(h)},i)})}function m(o){return o.split(/(\*\*[^*]+\*\*)/g).map((e,i)=>e.startsWith("**")&&e.endsWith("**")?n.jsx("strong",{className:"font-semibold text-gold-100",children:e.slice(2,-2)},i):n.jsx("span",{children:e},i))}export{u as HANDBOOK_CATEGORIES,g as HANDBOOK_ENTRIES,f as HandbookModal,j as WelcomeOverlay,P as hasSeenTutorial,L as markTutorialSeen,H as resetAllTutorials};
//# sourceMappingURL=index-DRiMzGer.js.map
