...
- **Liên hệ**: Gửi feedback qua hệ thống hỗ trợ của game
...
Game phục vụ giải trí. Không bảo hành về uptime, độ chính xác nội dung, hoặc khả dụng API bên thứ ba (Gemini/Firebase).
...
Người chơi giữ bản quyền nội dung tự nhập (background, custom story title).
...
Mọi góp ý vui lòng gửi qua kênh hỗ trợ trong game.`,
};
